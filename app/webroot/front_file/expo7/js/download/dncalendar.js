      ...
      return weeks;
		...
		*/
		var draw = function() {
          ...
          // create header label
          var headerGroup = $("<div id='dncalendar-header' class='dncalendar-header boxOut-textBulan'></div>");
          headerGroup.append("<font class='font-LatoBold'>"+ headerMonth +"</font>"+" "+"<font class='font-LatoLight'>"+ y +"</font>");
          ...
          var tableHeadRowGroup = $("<tr class='font-LatoBold'></tr>");
          ...
          var tableBodyGroup = $("<tbody class='font-LatoLight'></tbody>");
          ...
          for (var i = 0; i < nDates; i++) {
            ...
            for (var j = 0; j < nDate; j++) {
              ...
              var colDate = "<td id='' class='"+ colDateClass +" "+ ((showCalendarClick == true) ? 'calendarClick' : '') +"' data-date='"+ date +"' data-month='"+ month +"' data-year='"+ year +"'><div class='entry' "+ colDateDataAttr +"><a href='?date="+year+'-'+month+'-'+date+"'>"+ date +"</a></div></td>";
              
              if (minDate != null) {
                var myCurrentDate = new Date(year, month - 1, date);
                if (minDate > myCurrentDate) {
                  colDate = "<td class='"+ colDateClass +"' data-date='"+ date +"' data-month='"+ month +"' data-year='"+ year +"'><div class='entry' "+ colDateDataAttr +"><a href='#'>"+ date +"</a></div></td>";
                }
              } 
