                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 boxFlex">
                                            ...
                                            <div class="navbar navbar-default navbar-static navbar-edit-profil" style="margin-bottom: 0px;">
                                                ...
                                                <div class="navbar-offcanvas navbar-offcanvas-touch sidebar-canvas" id="sideMenu-profil">
                                                    ...
                                                    <ul class="nav navbar-nav nav-profil navbar-edit-menuLeft font-openSans">
                                                        <?php
                                                        $add_class = "";
                                                        foreach($termConditions['TermAndConditionDetail'] as $index => $list) {
                                                            if($index == 0) {
                                ...
                                <div class="col-md-11 col-sm-11 col-xs-10">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 box-titlePage font-PoppinsSemiBold">
                                                    <?= __("Term and Conditions")?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 textKebijakan font-LatoLight">
                                                    <?= $this->MultiLang->readLangClassic($termConditions['TermAndCondition'], "header") ?>
                                                </div>
                                            </div>
                                            <?php
                                            foreach($termConditions['TermAndConditionDetail'] as $index => $item) {                                            
                                            ?>
                                            <div class="row">
                                                <div id="syarat-<?= $index ?>" class="col-md-12 col-sm-12 col-xs-12 titleKebijakanPrivasi font-PoppinsSemiBold">
                                                    <?= $item['ordering_number'] . ". " . $this->MultiLang->readLangClassic($item,"title") ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 subBab-textKebijakan font-LatoLight">
                                                    <div class="row">
                                                        <?= $this->MultiLang->readLangClassic($item, "content") ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
...
<script>
    $(document).ready(function () {
        ...
        $('#sideMenu-profil').find('a').on('click', function (e) {
            ...
            $('html,body').animate({scrollTop: $(href).offset().top - 135}, 500);
