                ...
                <div class="col-md-12 col-sm-12 col-xs-12 box-content">
                    <div class=" inherit box-content-left mCustomScrollbar" data-mcs-theme="dark-3">
                        <ul class="nav nav-tabs tabs-left">
                            <?php                            
                            foreach ($dataAllSentMessage as $index => $sent) {
                                $lastIndex = count($sent['Child']) - 1;
                                if (!empty($sent['Child']) && count($sent['Child']) > 1) {
                                    if($sent['Child'][$lastIndex]['Sender']['id'] == $this->Session->read("credential.member.Account.id")) {
                                    ?>
                                    <li>
                                        <a href="#message-<?= $index+1 ?>" data-toggle="tab">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-2 col-sm-3 col-xs-3">
                                                    <div class="boxOut-foto-img">
                                                        <img src="<?= Router::url($sent['Child'][$lastIndex]['Sender']['User']['profile_picture'], true) ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-10 col-sm-9 col-xs-9 boxOut-borderMessage">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageTitle font-Roboboto-Bold">
                                                            <?= $sent['Child'][$lastIndex]['Sender']['Biodata']['full_name'] ?>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageText font-RobotoCondensed-Light">
                                                            <?php
                                                            $limit = 100;
                                                            $text = strip_tags($sent['Child'][$lastIndex]['content']);
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageTanggal font-RobotoCondensed-Light">
                                                            <?= $this->Html->cvtWaktu($sent['Child'][$lastIndex]['created']) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="inherit box-content-right">
                        <div class="inherit tab-content">
                            ...
                            $counter = 1;
                            $counter_form = 1;
                            foreach ($dataAllSentMessage as $index => $allSent) {
                                if (!empty($allSent['Child'])) {
                                    ?>
                                    <div class="inherit tab-pane mCustomScrollbar" data-mcs-theme="dark-3" id="message-<?= $counter ?>">
                                        <?php
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageContent-<?= $counter ?>">
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <?php
                                                                if ($allSent['Sender']['id'] != $this->Session->read("credential.member.Account.id")) {
                                                                    ?>
                                                                    <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageContent-<?= $counter ?>">
                                                    <div class="x_panel">
                                                        ...
                                                        <div class="x_content">
                                                            ...
                                                            <?php
                                                            if ($history['Sender']['id'] != $this->Session->read("credential.member.Account.id")) {
                                                                ?>
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-buttonMessage">
                                                                        <button type="button" class="btn button-reply font-RobotoCondensed reply" id="">Reply</button>
                                                        ...
                                                        if ($i == count($allSent['Child']) - 1) {
                                                            echo $this->Form->create('Message', ['action' => 'reply_message', 'type' => 'post', 'id' => 'replyMessage' . $counter_form]);
                                                            ?>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-sm-12 col-xs-12 boxOut-textArea">
                                                                                <div class="x_content">
                                                                                    ...
                                                                                    <input type="hidden" name="data[Message][parent_id]" value="<?= $history['Sender']['id'] ?>">
                                                                                </div>
                                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-textArea">
                                                                        <div class="x_content">
                                                                            ...
                                                                            <div id="editor<?= $counter_form ?>" class="editor-wrapper font-RobotoCondensed-Light" style="overflow:hidden; box-shadow: none; border-radius: 10px 10px 10px 10px; min-height: 160px; border: none; padding: 20px 30px 20px 30px;" contenteditable="true" data-text="Enter Text ..."></div>

                                                                            <textarea id="descr<?= $counter_form ?>" class="font-RobotoCondensed-Bold text-area" style="display:none;" name="data[Message][content]" placeholder="Enter Text ..." onkeyup="posting_to_textarea(<?= $counter_form ?>)"></textarea>
                                                                            <input type="hidden" name="data[Message][parent_id]" value="<?= $allSent['Message']['id'] ?>">
