...
class EchoHelper extends HtmlHelper {
    ...
    function __construct(View $View, $settings = array()) {
        $this->bulan[1] = __("Januari");
        $this->bulan[2] = __("Febuari");
        $this->bulan[3] = __("Maret");
        $this->bulan[4] = __("April");
        $this->bulan[5] = __("Mei");
        $this->bulan[6] = __("Juni");
        $this->bulan[7] = __("Juli");
        $this->bulan[8] = __("Agustus");
        $this->bulan[9] = __("September");
        $this->bulan[10] = __("Oktober");
        $this->bulan[11] = __("November");
        $this->bulan[12] = __("Desember");
