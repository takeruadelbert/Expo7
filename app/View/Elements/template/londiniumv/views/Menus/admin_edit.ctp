                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                            echo $this->Form->label("Menu.module_id", __("Module"), array("class" => "col-sm-3 col-md-4 control-label"));
                                            echo $this->Form->input("Menu.module_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "","placeholder"=>__("None")));
                                            ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                            echo $this->Form->label("Menu.ordering_number", __("Order"), array("class" => "col-sm-3 col-md-4 control-label"));
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                            echo $this->Form->label("Menu.position", __("Position"), array("class" => "col-sm-3 col-md-4 control-label"));
