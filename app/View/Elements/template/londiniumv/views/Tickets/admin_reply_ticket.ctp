<?php echo $this->Form->create("Ticket", array("class" => "form-horizontal form-separate", "action" => "reply_ticket", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table width="100%" class="table">
                        <div class="panel-heading" style="background:#2179cc">
                            <h6 class="panel-title" style=" color:#fff"><i class="icon-menu2"></i><?= __("Data Reply") ?></h6>
                        </div>
                        <tr>
                            <td>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <?php
                                            echo $this->Form->label("Ticket.title", __("Title"), array("class" => "col-sm-3 col-md-4 control-label"));
                                            echo $this->Form->input("Ticket.title", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "readonly"));
                                            ?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php
                                            echo $this->Form->label("Ticket.attachment", __("Attachment File"), array("class" => "col-sm-3 col-md-4 control-label"));
                                            echo $this->Form->input("Ticket.attachment", array("type" => "file", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control styled"));
                                            ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <?php
                                    echo $this->Form->label("Ticket.message", __("Content"), array("class" => "col-sm-2 control-label"));
                                    echo $this->Form->input("Ticket.message", array("div" => array("class" => "col-sm-10"), "label" => false, "class" => "ckeditor-fix", "placeholder" => "Enter text ...", "value" => ""));
                                    ?>
                                </div>
                            </td>
                        </tr>
