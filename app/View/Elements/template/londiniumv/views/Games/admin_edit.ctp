<?php echo $this->Form->create("Game", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Edit Game") ?>
                    </h6>
                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            echo $this->Form->input("Game.categories", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "default" => $category_id, "class" => "select-multiple", "empty" => "", "placeholder" => "- Select Category -", 'options' => $categories, 'multiple' => 'multiple'));
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9 col-md-8">
                                                <input type="file" class="form-control styled" name="data[Game][thumbnail]">
                                                <?php
                                                if (!empty($this->data['Game']['thumbnail_path'])) {
                                                    ?>
                                                    <img src="<?= Router::url($this->data['Game']['thumbnail_path'], true) ?>" width="100" height="70">
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9 col-md-8">
                                                <input type="file" class="form-control styled" name="data[Game][cover]">
                                                <?php
                                                if (!empty($this->data['Game']['cover_path'])) {
                                                    ?>
                                                    <img src="<?= Router::url($this->data['Game']['cover_path'], true) ?>" width="100" height="70">
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="block-row qq-upload-list" id="file-uploader-content-list">
                                            ...
                                            foreach ($this->data['GameDetail'] as $detail) {
                                                ...
                                                <div class="row row-table row-remove-<?php echo $i ?> qq-upload-success">
                                                    <div class="col-md-10 text-center"><img src="<?php echo Router::url($detail['image_path'], true) ?>" width="100"></div>
                                                    <input type="hidden" value="<?php echo $detail['image_path'] ?>" name="data[GameDetail][<?php echo $i ?>][image_path]">
                                                    <input type="hidden" value="<?php echo $detail['id'] ?>" name="data[GameDetail][<?php echo $i ?>][id]">
                                                    <div class="col-md-2 text-center"><a class="" onclick="hapusGambar(<?php echo $detail['id'] ?>, '<?php echo Router::url("/admin/game_details/delete/") ?>', <?php echo $i ?>);">Delete</a><span class="qq-upload-failed-text" style="color: red">Failed</span></div>
                                                </div>
                                                <?php
                                                $i++;
                                            }
                                    ...
                                    <div class="row">
                                        ...
                                        if (!empty($this->data['Game']['build_game_path'])) {
                                            ...
                                            <div class="col-md-3" style="padding-top: 5px;">
                                                <label>previous upload : <?= basename($this->data['Game']['build_game_path']) . ".zip" ?></label>
                                            </div>
                                            <?php
                                        }
                                        ?>
