        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Edit Role Access") ?>
                    </h6>
                </div>
                <div class="table-responsive">
                    <table width="100%" class="table">
                        <div class="panel-heading" style="background:#2179cc">
                            <h6 class="panel-title" style=" color:#fff"><i class="icon-menu2"></i><?= __("Role Access") ?></h6>
                        </div>
                        <tr>
                                        ...
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th width="50">#</th>
                                                    <th><?= __("Module") ?></th>
                                                    <th width="50" class="text-center"><?= __("Access") ?></th>
                                                    <th width="50" class="text-center"><?= __("Add") ?></th>
                                                    <th width="50" class="text-center"><?= __("Edit") ?></th>
                                                    <th width="50" class="text-center"><?= __("Delete") ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
