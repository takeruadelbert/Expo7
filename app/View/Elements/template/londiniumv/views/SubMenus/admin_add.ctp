        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Add Sub Menu") ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.menu_id", array("div" => array("class" => "col-sm-9 col-md-8"), "data-autolist-target" => "#SubMenuParentId", "data-autolist-url" => Router::url("/admin/sub_menus/list_by_menu/", true), "data-autolist-emptylabel" => "", "label" => false, "class" => "select-full autolist", "empty" => "", "placeholder" => "None"));
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.parent_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => __("None"), "options" => []));
                                            ?>
                                        </div>
                                    </div>
                                </div>
