                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"><?= $this->Html->cvtTanggal($item['Event']['event_date']) ?></td>
                                    <td class="text-center"><?= $item['Account']['Biodata']['full_name'] ?></td>
                                    <td class="text-center"><?= $item['EventStatus']['name'] ?></td>
                                    <td class="text-center">
                                        <a href="<?= Router::url("/admin/events/view/{$item['Event']['id']}") ?>"><button type="button" class="btn btn-default btn-xs btn-icon tip" title="Detail"><i class="icon-file"></i></button></a>
