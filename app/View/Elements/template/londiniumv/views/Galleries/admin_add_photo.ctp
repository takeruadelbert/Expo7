<?php echo $this->Form->create("Gallery", array("class" => "form-horizontal form-separate", "action" => "add_photo", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Add Gallery Photo") ?>
                    </h6>
                </div>
        ...
        var uploader = new qq.FileUploader({
            ...
            onComplete: function (id, fileName, responseJSON) {
                if (responseJSON.error === undefined) {
                    ...
                    $('#file-uploader-content-list .qq-upload-success').eq(id).prepend('<div class="col-md-8 text-center"><img src="' + src + '" width="100" name="data[DetailPhoto][' + count + '][gambar]"></div><div class="col-md-2 text-center"><input value="0" class="gallery_photo_default" type="checkbox" name=""><input value="0" class="gallery_photo_default" type="hidden" name="data[DetailPhoto][' + count + '][is_default]"></div><input type="hidden" value="' + responseJSON.src + '" name="data[DetailPhoto][' + count + '][image_path]">');
