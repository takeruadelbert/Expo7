...
<ul class="navigation">
    <li class="<?= $url == "admin/dashboard" ? "active" : "" ?>"><a href="<?= Router::url("/admin/dashboard", true) ?>"><span><?= __("Dashboard") ?></span> <i class="icon-screen2"></i></a></li>
    <li class="<?= $url == "admin/employees/profil" ? "active" : "" ?>"><a href="<?= Router::url("/admin/employees/profil", true) ?>"><span><?= __("Profile") ?></span> <i class="icon-user"></i></a></li>
    <?php
    ...
    ?>
    <li class="<?= $url == "admin/accounts/change_password" ? "active" : "" ?>"><a href="<?= Router::url("/admin/accounts/change_password", true) ?>"><span><?= __("Change Password")?></span> <i class="icon-lock"></i></a></li>
    <li><a href="<?= Router::url("/admin/logout", true) ?>"><span><?= __("Logout")?></span> <i class="icon-exit"></i></a></li>
</ul>