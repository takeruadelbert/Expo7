<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="<?= Router::url("/admin/dashboard", true) ?>"><img style="height:50px" src="<?= Router::url("/img/logo.png", true) ?>" alt="Expo 7" title="<?= _APP_CORPORATE ?>"></a>
    ...
    $notifications[] = [
        "message" => __("Notification Example"),
            ...
            <div class="popup dropdown-menu dropdown-menu-right">
                ...
                <ul class="activity">
                    ...
                    if (!empty($notifications)) {
                        ...
                        ?>
                        <li class="text-center"><?= __("No Notification") ?></li>
                        <?php
                    }
                    ?>
