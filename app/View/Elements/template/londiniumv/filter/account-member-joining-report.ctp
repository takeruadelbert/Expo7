            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <?= $this->Form->input(null, array("options" => $accountStatuses, "default" => isset($this->request->query['select_Account_account_status_id']) ? $this->request->query['select_Account_account_status_id'] : '', "name" => "select.Account.account_status_id", "div" => false, "label" => false, "class" => "select-full", "empty" => "", "placeholder" => __("-All-"))) ?>
                    </div>
                    <div class="col-md-2">
                        <label><?= __("Joining Period") ?></label>
                        <?= $this->Form->input(null, array("default" => isset($this->request->query['awal_Member_joining_dt']) ? $this->request->query['awal_Member_joining_dt'] : '', "name" => "awal.Member.joining_dt", "div" => false, "label" => false, "class" => "form-control tip datepicker", "placeholder" => __("Start period"))) ?>
                    </div>
                    <div class="col-md-2">
                        <label>&nbsp;</label>
                        <?= $this->Form->input(null, array("default" => isset($this->request->query['akhir_Member_joining_dt']) ? $this->request->query['akhir_Member_joining_dt'] : '', "name" => "akhir.Member.joining_dt", "div" => false, "label" => false, "class" => "form-control tip datepicker", "placeholder" => __("End period"))) ?>
                    </div>
                </div>
            </div>
