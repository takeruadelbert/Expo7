            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, array("default" => isset($this->request->query['Menu_module_id']) ? $this->request->query['Menu_module_id'] : '', "name" => "Menu.module_id", "div" => false, "label" => false, "class" => "select-full", "options" => $modules, "empty" => "", "placeholder" => __("- All -"))) ?>
                    </div>
                </div>
            </div>
